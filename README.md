...
| Frontend | React · Angular · Astro · Next.js · TypeScript · Tailwind CSS |
| LLM / Agents | Anthropic Claude · Google Gemini · raw SDK, no frameworks |
| Cloud | AWS · Azure · Kubernetes · Terraform · Docker |
| Testing | Pact · Cypress · Vitest |
